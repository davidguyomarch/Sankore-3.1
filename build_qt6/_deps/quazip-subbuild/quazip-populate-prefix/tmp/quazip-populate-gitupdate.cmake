...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.4"
  WORKING_DIRECTORY "/workspace/build_qt6/_deps/quazip-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.4" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/build_qt6/_deps/quazip-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/build_qt6/_deps/quazip-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
